...
{% include 'figure-ext.html' with include.image='/Space-Explorer-Game/assets/mainPageScreen/img1.jpg' include.width=550 include.height=1600 include.caption='Добро пожаловать в неизведанный космический мир, где ждут захватывающие приключения и опасные бои. Вы - один из немногих свободных пилотов, которые нанимаются Федерацией для помощи в подготовке к предстоящему инопланетному сражению.' include.image_position='left' %}
